...
//        private let angleCalculationService = AngleCalculationService()
//        
//        init() {
...
//                SelectBuildingView()
//            case .ar:
//                MyARView().edgesIgnoringSafeArea(.all)
//            }
//        }
//    }
//extension Coordinator: ARSessionDelegate, ARSCNViewDelegate {
//    func session(_ session: ARSession, didUpdate frame: ARFrame) {
//        arCameraService.updateCameraPosition(frame: frame)
//        
//        if let boxNode = arObjectDetectionService.getBoxNode(from: session) {
//            let (horizontalAngle, verticalPosition) = angleCalculationService.calculate2DAngleAndVerticalPosition(to: boxNode, from: frame)
